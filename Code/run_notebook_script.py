...
parser.add_argument('-d', '--depths', type=list, default=[2, 5, 10, 20, 25, 30], help='Depths of the network (list format)')
parser.add_argument('-lr', '--learning_rates', type=list, default=[0.01, 0.001, 0.1], help='Learning rates (list format)')
parser.add_argument('-opt', '--optimizers', type=list, default=['Adam', 'SGD'], help='Optimizers (list format)')
